...
Closed.Image = "rbxassetid://16565778952"
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            function main:AddDropdown(text,table,callback)
                ...
                DropImage.Image = "rbxassetid://16565778952"
        ...
        for i,v in pairs(Site.data) do
            ...
            if tonumber(v.maxPlayers) > tonumber(v.playing) then
                ...
                if Possible == true then
                    ...
                    pcall(function()
                        wait()
                        game:GetService("Teleport ĐếnService"):TeleportToPlaceInstance(PlaceID, ID, game.Players.LocalPlayer)
                    end)
                    wait(4)
                end
            end
...
---------------------------------------------------------------------------Create Tab
local SOMEXHUB = library:AddWindow("CHUỐI TUƠI HUB",Enum.KeyCode.RightControl)
local Main = SOMEXHUB:AddTab("Farm","13075651575")
local Sea = SOMEXHUB:AddTab("Sea event","13075651575")
local M = SOMEXHUB:AddTab("Item","13075622619")
local Ss = SOMEXHUB:AddTab("Stat","7040410130")
local RaceV4 = SOMEXHUB:AddTab("Race","11162889532")
local P = SOMEXHUB:AddTab("Playes","7251993295")
...
local D = SOMEXHUB:AddTab("Devil Fruits","7044233235")
local Misc = SOMEXHUB:AddTab("misic","11156061121")
---------------------------------------------------------------------------
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
...
Main:AddToggle("Auto Level 1-2550",false,function(value)
       _G.AutoFarm = value
...
Main:AddDropdown("Chọn Quái",tableMon,function(vu)
    ...
    Main:AddToggle("Auto Quái Chọn",_G.AutoFarmMob,function(value)
 ...
 spawn(function()
   ...
   if World3 then   
	   ...
	   Main:AddToggle("Auto Chets",_G.chestsea3,function(value)
	_G.chestsea3 = value
	StopTween(_G.chestsea3)
	  ...
	  if World2 then
	   ...
	   Main:AddToggle("Auto Chets",_G.chestsea2,function(value)
	_G.chestsea2 = value
	StopTween(_G.chestsea2)
   end)
	   end
   
Main:AddToggle("Auto Chets Migare",false,function(value)
...
Main:AddDropdown("Chọn Chế Độ", ListC,function(value)
    ...
    Main:AddToggle("Auto Farm Katakuri",_G.AutoDoughtBoss,function(value)
...
spawn(function()
    ...
    Main:AddToggle("Auto Fram Katakuri V2", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Main:AddToggle("Hop Server", _G.AutodoughkingHop,function(value)
...
elseif World3 then
    ...
    Main:AddToggle("Auto Fram Boss",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:AddToggle("Auto Farm Quets Boss Server",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("Quets Boss Hop Server",_G.AutoAllBossHop,function(value)
...
Main:AddToggle("FastAttack",true,function(Mag)
    _G.FastAttack = Mag
            end)
...
Main:AddToggle("Gather monsters",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
M:AddToggle("Teleport Migare",_G.AutoMysticIsland,function(value)
    ...
    M:AddToggle("Auto Lái Thuyền",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    M:AddToggle("Auto Triệu Hồi Đảo Bí Ẩn",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
spawn(function()
   ...
   M:AddSeperator("Misc Mastery")
    ...
    M:AddToggle("Auto Thông Thạo BF",_G.AutoFarmFruitMastery,function(value)
    ...
    M:AddToggle("Auto Thông Thạo Súng",_G.AutoFarmGunMastery,function(value)
...
function EquipWeaponSword()
    ...
    M:AddToggle("Auto Thông Thạo Kiếm",_G.AutoSwordMastery,function(value)
...
M:AddToggle("Auto Tushita", _G.Autotushita,function(value)
    ...
    M:AddToggle("Auto Farm Pirate Raid", _G.AutoCarvender,function(value)
     _G.RaidPirate = value
    ...
    M:AddToggle("Auto Farm Elite Hunter",_G.AutoElitehunter,function(value)
    ...
    M:AddToggle("Quets Hallow Scythe Hop",_G.AutoFarmBossHallowHop,function(value)
    ...
    M:AddToggle("Auto Kill Rip_indra Boss Hop",_G.AutoDarkDagger_Hop,function(value)
...
M:AddToggle("Auto Sea Beast",_G.Auto_Seabest,function(value)
...
M:AddToggle("Auto Phá Huỷ Thuyền Khi Chết",_G.AutoDesBoat,function(value)
...
M:AddToggle('Auto Đánh Thuyền', false, function(value)
    PirateShip = value
    end)
spawn(function()
        while wait() do
...
M:AddDropdown("Chọn Chế Độ", ListB,function(value)
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    M:AddToggle("Auto Random Bone",_G.Auto_Random_Bone,function(value)
                                ...
                                if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                    ...
                                    repeat task.wait()
                                        ...
                                        if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoObservation_Hop == true then
                                            game:GetService("Teleport ĐếnService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                        end
...
Ss:AddToggle("Stats Kaitun",_G.Auto_Stats_Kaitun,function(value)
_G.Auto_Stats_Kaitun = value
end)
...
RaceV4:AddButton("Npc Buy Gear",function()
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  ...
  RaceV4:AddButton("Teleport Đến Cyborg",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  RaceV4:AddButton("Teleport Đến Fish",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  RaceV4:AddButton("Teleport Đến Ghoul",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  RaceV4:AddButton("Teleport Đến Human",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  RaceV4:AddButton("Teleport Đến Mink",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  RaceV4:AddButton("Teleport Đến Sky",function()
  topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
  end)

  RaceV4:AddSeperator("Auto Complete Trials")
  
  RaceV4:AddToggle("Auto Kill Player",false,function(Val)
  _G.AutoKillTial = Val
  StopTween(_G.AutoKillTial)
  end)
  RaceV4:AddToggle("Auto Hoàn Thành Ải",false,function(v)
  _G.AutoQuestRace = v
...
spawn(function()
    ...
    P:AddToggle("Teleport Đến",false,function(value)
    ...
    P:AddToggle("Teleport Đến Player Bypass",false,function(bool)
                                    _G.Teleport = bool
...
spawn(function()
    ...
    spawn(function()
        ...
        R:AddToggle("Teleport Qua Đảo",_G.Auto_Dungeon,function(value)
...
spawn(function()
    ...
    R:AddToggle("Auto Thức Tỉnh Fruit",_G.Auto_Awakener,function(value)
    ...
    R:AddToggle("Kill Quái[Pro]",nil,function(value)
    _G.Kill_Aura = value
    end) 
...
spawn(function()
    ...
    if World2 then
        R:AddButton("Teleport Đến Lab",function()
    ...
    R:AddToggle("ESP Players",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    R:AddToggle("ESP Chets",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    R:AddToggle("ESP Frui",false,function(a)
        DevilFruitESP = a
 ...
 R:AddToggle("Auto Law Sword", _G.AutoOderSword,function(value)
    ...
    R:AddButton("Buy Chip Law Boss",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    R:AddButton("Auto Raid Law Boss",function()
        if World2 then
    ...
    T:AddButton("Teleport Third Sea",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    ...
    T:AddToggle("Teleport Đến",false,function(value)
    ...
    T:AddToggle("Teleport Đến",_G.TeleportNPC,function(value)
...
S:AddButton("Random Race (Use 3K Fragments)", function()
    ...
    spawn(function()
        ...
        D:AddButton("Cửa hàng Fruit",function()
...
spawn(function()
    ...
    Misc:AddButton("Go back to the server",function()
...
Misc:AddButton("Devil Shop",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
    game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
end)
...
Misc:AddButton("Inventory Fruit",function()
...
Misc:AddButton("Pirates Team",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
end)

Misc:AddButton("Marines Team",function()
...
Misc:AddButton("bright sky",function()
    ...
    Misc:AddToggle("Clear fog",RemoveFog,function(value)
        RemoveFog = value
